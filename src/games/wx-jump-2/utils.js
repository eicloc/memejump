...
export const colors = [
  ...
  {
    path: "./textures/etc.png",
    color: 0xff9eae,
  },
  {
    path: "./textures/ethereum.png",
    color: 0x5546bf,
  },
  {
    path: "./textures/pepe.png",
    color: 0x3d8130,
  },
  {
    path: "./textures/toncoin.png",
    color: 0x0088cc,
  },
  {
    path: "./textures/bnb.png",
    color: 0xf0b90b,
  },
  {
    path: "./textures/usdt.png",
    color: 0x50af95,
  },
  {
    path: "./textures/solana.png",
    color: 0x000000,
  },
];
...
//crypto logos
// const texture = new THREE.TextureLoader().load("http://songnes.com/g/im1.png");
// var texture = new THREE.TextureLoader().load(require("./bitcoin.png"));
